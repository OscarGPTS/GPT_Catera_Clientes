...
// M0: Auth0 SDK queda inerte hasta el Hito 1, donde se configura
// AuthOrchestrator + tabla auth_providers (D6). Las flags abajo evitan
// que la SDK tome el guard 'web' por defecto sin credenciales reales.
return Configuration::VERSION_2 + [
    'registerGuards' => env('AUTH0_REGISTER_GUARDS', false),
    'registerMiddleware' => env('AUTH0_REGISTER_MIDDLEWARE', false),
    'registerAuthenticationRoutes' => env('AUTH0_REGISTER_ROUTES', false),
